...
You create Insight Trackers directly in the Journium dashboard. You can create a new tracker for your application instance at [Developers | Insight Trackers | Create New](https://dashboard.journium.app/apps/j_app~/instances/j_app_inst~/developers/insight-trackers/new)
Each tracker is configured through several sections:
