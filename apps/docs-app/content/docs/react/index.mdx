...
icon: Rocket
keywords: analytics SDK for React, developer analytics SDK, in-app analytics for developers, AI product analytics
---
...
<CloneExampleRepo 
  ...
  message="Clone the React + Vite example repository to get started quickly"
/>
...
<Callout type="info">
When you create an app in Journium, a default [Insight Tracker](/docs/react/concepts/insight_trackers) is automatically created. This tracker helps you test data ingestion and insight generation.
</Callout>
