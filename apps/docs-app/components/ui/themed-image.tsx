...
export function ThemedImage({ srcLight, srcDark, alt, className, ...props }: ThemedImageProps) {
  ...
  return <Image src={src} alt={alt || ''} className={className} suppressHydrationWarning {...props} />;
}
