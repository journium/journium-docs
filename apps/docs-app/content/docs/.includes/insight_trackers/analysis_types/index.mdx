...
<Cards>
  <Card title="Funnel Analysis" href="./analysis_types/funnel" icon={<GitMergeIcon />}>
    Track ordered step completion and identify where users drop off.
  </Card>
  <Card title="Retention Analysis" href="./analysis_types/retention" icon={<RefreshCwIcon />}>
    Cohort return-rate curves over time — D1, D7, D30, and beyond.
  </Card>
  <Card title="Activation Analysis" href="./analysis_types/activation" icon={<ZapIcon />}>
    Measure what percentage of new users reach the first value moment.
  </Card>
  <Card title="Churn Risk Analysis" href="./analysis_types/churn" icon={<UserMinusIcon />}>
    Identify users who were active but have since gone silent.
  </Card>
  <Card title="Feature Adoption" href="./analysis_types/feature_adoption" icon={<ToggleRightIcon />}>
    What fraction of active users have tried a specific feature.
  </Card>
  <Card title="Anomaly Detection" href="./analysis_types/anomaly" icon={<AlertTriangleIcon />}>
    Automated spike and dip detection vs. a statistical baseline.
  </Card>
  <Card title="Conversion Rate" href="./analysis_types/conversion" icon={<ArrowRightLeftIcon />}>
    Simple numerator / denominator rate — percentage of group A that does B.
  </Card>
  <Card title="Cohort Analysis" href="./analysis_types/cohort" icon={<UsersIcon />}>
    Compare a metric across cohorts defined by join date or a property value.
  </Card>
  <Card title="Trend / Growth" href="./analysis_types/trend" icon={<TrendingUpIcon />}>
    Count events or unique users per time period — daily, weekly, monthly.
  </Card>
  <Card title="Custom (Deprecated)" href="./analysis_types/custom" icon={<ArchiveIcon />}>
