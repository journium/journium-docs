...
We're excited to announce the **Journium MCP server**—that connects AI agents directly to Journium documentation. 
Your AI assistant can now search our docs, retrieve pages, and answer questions about Journium without leaving your editor.
