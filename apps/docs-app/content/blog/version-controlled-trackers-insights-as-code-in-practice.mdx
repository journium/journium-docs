...
We're excited to announce full support for **[version-controlled insight trackers](/blog/insights-as-code-shifting-product-intelligence-left)** in Journium. Define, review, and deploy your product intelligence exactly like you ship code—in Git, through pull requests, with automatic deployments.
