...
export const metadata: Metadata = {
  ...
  description: "Journium turns raw telemetry into proactive, narrative insights — without charts, queries, or BI. An awareness layer for modern applications that speaks up when something meaningful changes.",
  keywords: [
    'telemetry',
    'observability',
