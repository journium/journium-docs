...
icon: Rocket
keywords: developer analytics SDK, in-app analytics for developers, serverless analytics, product analytics tool
---
...
<Callout type="info">
When you create an app in Journium, a default [Insight Tracker](/docs/react/concepts/insight_trackers) is automatically created. 
...
<Cards>
  ...
  <Card title="Insight Trackers" href="/docs/js/concepts/insight_trackers">
