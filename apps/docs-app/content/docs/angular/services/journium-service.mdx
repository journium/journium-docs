...
description: Injectable Angular service for tracking events, identifying users, and managing pageviews with the Journium SDK.
icon: Zap
...
`JourniumService` is the main injectable Angular service provided by `@journium/angular`. It wraps the core JavaScript SDK and exposes all analytics methods for use throughout your Angular application.
