...
interface ShopifyIconProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
}

export function ShopifyIcon({ className, ...props }: ShopifyIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlSpace="preserve"
      style={{ enableBackground: 'new 0 0 109.5 124.5' } as React.CSSProperties}
