...
icon: Rocket
keywords: analytics SDK for NextJS, developer analytics SDK, product analytics tool, in-app analytics for developers
---
...
<Callout type="info">
When you create an app in Journium, a default [Insight Tracker](/docs/concepts/insight_trackers) is automatically created. This tracker helps you test data ingestion and insight generation.
</Callout>
...
<Cards>
  ...
  <Card title="Insight Trackers" href="/docs/concepts/insight_trackers">
